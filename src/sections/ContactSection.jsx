...
const CalBooking = lazy(() => import("../components/CalBooking.jsx").then((module) => ({ default: module.CalBooking })));
            ...
            {loadCal ? (
              <Suspense
                fallback={
                  <div
                    aria-hidden="true"
                    className="h-[560px] w-full animate-pulse rounded-2xl bg-slate-100 sm:h-[660px]"
                  />
                }
              >
                <CalBooking />
              ...
              <div
                aria-hidden="true"
                className="h-[560px] w-full rounded-2xl bg-slate-100 sm:h-[660px]"
              />
            )}
          </motion.div>
        </motion.div>
